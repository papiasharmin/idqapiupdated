...
// RPC URL
const RPC_URL = 'https://rpc-evm-sidechain.xrpl.org';//`https://polygon-mumbai.g.alchemy.com/v2/${API_KEY}`;//`https://eth-sepolia.g.alchemy.com/v2/3fMr3CwsUtbgtcenWRgX9A0Cx9tkOfVr`;// //`https://eth-goerli.g.alchemy.com/v2/${API_KEY}`;
